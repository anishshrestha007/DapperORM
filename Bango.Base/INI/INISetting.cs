...
namespace Bango.Base.INI
{
    public class INISetting
    {
        ...
        private DictionaryFx<string, DictionaryFx<string, string>> _settings = new DictionaryFx<string, DictionaryFx<string, string>>();
        ...
        public DictionaryFx<string, DictionaryFx<string, string>> Settings
        {
        ...
        {
            _settings.Add(section, new DictionaryFx<string, string>());
        }
