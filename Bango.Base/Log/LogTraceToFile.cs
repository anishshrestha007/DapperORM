...
namespace Bango.Base.Log
{
    ...
    public static class LogTraceToFile
    {
        ...
        public static string defTraceID = "ProductName" + "_log";
        private static string _defaultLogFolder = @".\";

        /*public static string defTraceID = System.Windows.Forms.Application.ProductName + "_log";
        private static string _defaultLogFolder = System.Windows.Forms.Application.StartupPath;*/
            ...
            try
            {
                if (m_htTraceFileInfo.ContainsKey(TraceID))
                {
                    ...
                    if (_defaultLogFolder.Trim().Length == 0)
                        _defaultLogFolder = "";
                    //TODO:: _defaultLogFolder = System.Windows.Forms.Application.StartupPath;
